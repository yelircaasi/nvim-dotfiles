function setups.ui()
	...
	setup_plugin("render-markdown", render_markdown_defaults)
	-- OLD utils.packadd("markdown-preview")

	-- https://github.com/iamcco/markdown-preview.nvim
	-- markdown preview plugin for (neo)vim
	setup_plugin("mkdp", function(mkdp)
		...
		vim.g.mkdp_preview_options = {
			...
			sequence_diagrams = {},
			flowchart_diagrams = {},
			content_editable = false, -- TODO: correct translation?
			disable_filename = 0,
			toc = {},
		}
		...
		vim.g.mkdp_images_path = "/home/user/.markdown_images" -- TODO
...
local function set_markdown_options()
	print("PLACEHOLDER")
end
